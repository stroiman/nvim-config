...
let g:projectionist_heuristics['tsconfig.json'] = {
      ...
      \ 'src/i18n/da/*.json': { 'command': 'da', 'alternate': ['src/i18n/en/{}.json', 'src/i18n/de/{}.json'] },
      \ 'src/i18n/en/*.json': { 'command': 'en', 'alternate': ['src/i18n/da/{}.json', 'src/i18n/de/{}.json'] },
      \ 'src/i18n/de/*.json': { 'command': 'de', 'alternate': ['src/i18n/en/{}.json', 'src/i18n/da/{}.json'] }
      \ }
